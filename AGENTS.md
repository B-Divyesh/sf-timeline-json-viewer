# Local viewer for exported Google Maps Timeline JSON (`timeline-json-viewer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://timeline-json-viewer.sociobot.in`. Artifact class: `pwa-offline`.
